...
/**
 * The primary key class for the supervisionaServico database table.
 * 
 */
@Embeddable
public class SupervisionaServicoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SupervisionaServicoPK)) {
			return false;
		}
		SupervisionaServicoPK castOther = (SupervisionaServicoPK)other;
		return 
