...
values(1234567890, 'teste1', 1111111111, '2003-02-01', 'santa rita', 'minas gerais', 'brasileira', 'M', 'solteiro', 3534567890, 35988887777, null, 'false');

insert into "public"."dadospessoais" ("cpf", "nome", "rg", "datanascimento", "naturalidade", "uf", "nacionalidade", "sexo", "estadocivil", "telefone", "celular", "telefonerecado", "ativo") 
values(2345678901, 'teste2', 1111111111, '2004-02-01', 'santa rita', 'minas gerais', 'brasileira', 'F', 'solteiro', 3534567890, 35988887777, null, 'false');
